...
export function ManageFeaturedMovie() {
  ...
  const [featured, setFeatured] = useState<TmdbMovie | null>(() =>
    getFeaturedMovie(),
  );
  ...
  const backdropUrl = featured
    ? TMDB_IMAGE(featured.backdrop_path, "original")
    : null;
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Text type="secondary" style={{ display: "block", marginBottom: 24 }}>
        Chọn bộ phim hiển thị ở banner lớn (hero section) khi người dùng vào
        trang chủ.
      </Text>
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    {(featured.original_language || "EN").toUpperCase()}
                  </div>
      ...
      <Card title="Tìm phim để đặt làm biểu ngữ" style={{ marginBottom: 24 }}>
        ...
        >
          Nhấn Enter hoặc nút "Tìm" để tìm kiếm. Kết quả từ TMDB, hỗ trợ cả tên
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              {" · "}
                              <StarFilled
                                style={{ color: "#e9c400", fontSize: 10 }}
                              />{" "}
